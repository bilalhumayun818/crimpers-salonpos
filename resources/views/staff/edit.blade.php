                ...
                <div class="form-card-body">
                    <div class="f-grid-2" style="margin-bottom:16px;">
                        ...
                        <div class="f-group">
                            ...
                            <input type="date" name="date_of_birth" value="{{ old('date_of_birth', $staff->date_of_birth?->format('Y-m-d')) }}" required class="f-input">
                        </div>
                    </div>
                    <div class="f-grid-2">
                        <div class="f-group">
                            <label class="f-label">Phone Number <span>*</span></label>
                            <input type="text" name="phone" value="{{ old('phone', $staff->phone) }}" required class="f-input">
                        </div>
                        <div class="f-group">
                            <label class="f-label">Emergency Number <span>*</span></label>
                            <input type="text" name="emergency_number" value="{{ old('emergency_number', $staff->emergency_number) }}" required class="f-input">
                        </div>
                    </div>
                    <div class="f-grid-2">
                        <div class="f-group">
                            <label class="f-label">CNIC <span>*</span></label>
                            <input type="text" name="cnic" value="{{ old('cnic', $staff->cnic) }}" required class="f-input">
                        </div>
                        <div class="f-group">
                            <label class="f-label">Monthly Salary (PKR) <span>*</span></label>
                            <input type="number" name="salary" value="{{ old('salary', $staff->salary) }}" min="0" step="0.01" required class="f-input">
                        </div>
                    </div>
                    <div class="f-group" style="margin-top:16px;">
                        <label class="f-label">Home Address <span>*</span></label>
                        <textarea name="address" required class="f-textarea">{{ old('address', $staff->address) }}</textarea>
                    </div>
                </div>
            </div>
